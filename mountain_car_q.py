...
def run(episodes, is_training=True, render=False):
    ...
    learning_rate_a = 0.9 # How much to adjust the Q-value during updates.
    discount_factor_g = 0.9 # Importance of future rewards..

    epsilon = 1        # Start with 100% random actions.
    epsilon_decay_rate = 2/episodes # Reduce randomness over episodes.
